<template>
  <div class="flex bg-white p-4 min-h-screen">
    <div class="flex-1 p-4">
      ...
      <!-- Banner -->
      <div class="relative mb-4 bg-pink-500 rounded-lg flex items-center">
        ...
        <p
          class="absolute text-white text-xl z-10"
          style="left: 20px; top: 55%; transform: translateY(-50%)"
        >
          Mulai dari dini
        </p>
...
import headerImage1 from '/img2.png'
