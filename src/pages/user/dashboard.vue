<template>
  <div class="flex bg-white p-4 min-h-screen">
    <div class="flex-1 max-w-full p-4">
      ...
      <!-- Banner -->
      <div class="h-24 relative mb-4 bg-pink-500 rounded-lg flex items-center md:h-52">
        <!-- Tulisan "Kesehatan Gigi" -->
        <h2
          class="absolute ml-4 mt-0 md:left-5 md:top-1/2 md:transform md:-translate-y-1/2 text-sm text-white md:text-3xl font-bold z-10"
        >
          Kesehatan Gigi
        </h2>

        <p
          class="absolute ml-4 mt-6 text-xs md:left-5 md:top-3/4 md:transform md:-translate-y-1/2 text-white md:text-base z-10 md:mt-0"
        >
          Mulai dari dini
        </p>
      ...
      <div class="bg-gradient-to-tl from-pink-500/10 to-white h-20 rounded-lg md:hidden mb-4">
        <div class="flex h-20 p-3 rounded-lg shadow-md">
      ...
      <div class="grid grid-cols-3 mb-4 gap-4 md:hidden">
        <div class="bg-red-500 rounded-lg">
          <div
            ...
            style="background: linear-gradient(135deg, white 60%, #fce4ec 80%, #fad1e8 100%)"
          >
            <div class="flex flex-col items-center justify-center mb-2">
              <div class="flex flex-col items-center">
                ...
                <p class="text-3xl font-bold text-center">5</p>
              </div>
            </div>

            <div class="flex items-center justify-between">
              <p class="text-xs font-bold">Total Periksa</p>
            </div>
          </div>
        </div>
        <div class="bg-red-500 rounded-lg">
          ...
          >
            ...
            <div class="flex items-center justify-between">
              <p class="text-xs font-bold">Monitoring Anak</p>
            </div>
          </div>
        </div>
        <div class="bg-red-500 rounded-lg">
          ...
          >
            ...
            <div class="flex items-center justify-between">
              <p class="text-xs font-bold">Monitoring Ibu</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- tampilan desktop -->
      <div>
        <div class="md:grid grid-cols-4 gap-4 mb-4 hidden">
          <div class="bg-red-500 rounded-lg">
            <div
              id="card"
              ...
              style="
                background: linear-gradient(
                  135deg,
                  white 60%,
                  /* Warna putih mengisi hingga 60% area */ #fce4ec 80%,
                  /* Gradasi ke warna pink muda dimulai dari 60% hingga 70% */ #fad1e8 100%
            ...
            >
              <div class="flex items-center justify-between mb-2">
                <div class="flex items-center space-x-2">
                  ...
                  <h3 class="font-bold">Total Periksa</h3>
                </div>
                <div class="flex items-center space-x-4">
            ...
            >
              <div class="flex items-center justify-between mb-2">
                <div class="flex items-center space-x-2">
                  ...
                  <h3 class="font-bold">Monitoring Anak</h3>
                </div>
                <div class="flex items-center space-x-4">
                  <p class="text-3xl font-bold">5</p>
                </div>
            ...
            >
              <div class="flex items-center justify-between mb-2">
                <div class="flex items-center space-x-2">
                  ...
                  <h3 class="font-bold">Monitoring Ibu</h3>
                </div>
                <div class="flex items-center space-x-4">
                  <p class="text-3xl font-bold">5</p>
                </div>
          ...
          <div class="">
            ...
            <div class="bg-white p-4 rounded-lg shadow-md flex flex-col overflow-y-auto">
              <div class="flex justify-between items-center mb-2">
                ...
                <a href="#" class="text-gray-500">Lihat Semua</a>
              </div>
              <ul class="flex-grow">
                <li class="mb-3 border-b border-gray-300 pb-3">
                  <div class="flex justify-between">
                    <p class="font-medium">Dusun Menoreh 1</p>
                    <span class="text-black">01 Oktober 2024</span>
                  </div>
                  <div class="flex justify-between">
                    <p class="text-gray-500">Puskesmas</p>
                    <span class="text-gray-500">08:00-09:00</span>
                  </div>
                </li>
          ...
          <div class="w-full h-10">
            <div>
              <div class="flex justify-between items-center mb-2 w-full">
                ...
                <a href="#" class="text-grey-500 pb-6" style="padding-top: 10px">Lihat Semua</a>
              </div>
              <div class="flex overflow-x-auto gap-4 mb-4 h-56 w-full" style="">
                <!-- Card 1 -->
                <div class="bg-white h-56 p-4 rounded-lg shadow-md flex flex-col justify-between">
                  <img
                  ...
                  <div class="flex-grow">
                    ...
                    <p class="text-xs text-gray-500 overflow-hidden text-ellipsis truncate h-10">
                    ...
                    <div class="flex items-center space-x-2">
                      <a
                        ...
                        class="text-xs overflow-hidden text-ellipsis text-pink-500 hover:underline"
                      >
                        Baca Selengkapnya
                      </a>
                      <svg
        ...
        <div class="w-full hidden md:flex">
          <div class="w-3/4">
            <div>
              ...
              <div class="grid grid-cols-3 gap-4 mb-4" style="">
                <!-- Card 1 -->
                <div class="bg-white p-4 rounded-lg shadow-md flex flex-col justify-between">
                  ...
                  <div>
                    ...
                    <div class="flex items-center space-x-2">
                      <a href="https://example.com" class="text-pink-500 hover:underline">
                        Baca Selengkapnya
                      </a>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="bg-white p-4 rounded-lg shadow-md flex flex-col justify-between">
                  <img
                    class="w-full h-32 object-cover rounded-lg mb-2"
                    src="/card-header2.png"
                    alt="Gambar Artikel"
                  />
                  <div>
                    <h3 class="font-bold">Pentingnya ASI</h3>
                    <p class="text-gray-500">
                      Here are the biggest enterprise technology acquisitions of 2021 so far, in
                      reverse chronological order.
                    </p>
