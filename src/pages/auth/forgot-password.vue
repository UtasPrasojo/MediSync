...
<template>
  <div class="flex min-h-screen">
    <!-- Left Side (Form) -->
    <div class="w-full md:w-1/2 flex flex-col justify-center items-center bg-white p-4">
      ...
      <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <h3 class="text-center text-xl leading-9 tracking-tight text-black">Lupa Password</h3>
