    ...
    <div class="flex min-h-screen">
      ...
      <div class="w-full md:w-1/2 flex justify-center items-center bg-white p-4">
        <div class="bg-white p-2 w-full max-w-md flex flex-col items-center space-y-6 mb-6">
          ...
          <div class="flex items-center space-x-2 mb-4"> <!-- Added flex container -->
            <svg
            ...
            <form class="space-y-6 mt-10" action="#" method="POST">
              ...
              <div class="flex items-center justify-center space-x-2">
                ...
                <input
                  ...
                  type="text"
                  maxlength="1"
                  class="w-12 h-12 text-center border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-600 focus:outline-none"
                  v-model="otp[index]"
                />
              </div>
