<template>
  <div class="flex flex-col md:flex-row min-h-screen">
    <!-- Left Side (Form) -->
    <div class="flex-1 flex justify-center items-center bg-white p-4">
      <div class="bg-white p-8 rounded-lg w-full max-w-md">
        ...
        <div class="text-center mb-4">
          <img src="/img2.png" alt="OTP Image" class="mx-auto w-110 h-50 object-cover" />
        </div>
        <p class="text-center font-medium leading-9 text-gray-900 mb-4">
          Kami telah mengirim Instruksi Untuk Mengganti Password
        </p>
        <p class="text-center font-medium leading-9 text-gray-900 mb-4">
          Belum Menerima?
          <a href="#" class="text-pink-500 hover:text-pink-600 font-semibold cursor-pointer">
            Kirim ulang
          </a>
        </p>
      </div>
